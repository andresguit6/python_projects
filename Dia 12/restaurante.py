...
# dar iniciacion a tkinter

aplicacion = Tk()

# tamao de la ventana (1020+630 tamaño de la ventana emergente+donde se quiere posicionar en pycharm 0+0)
# (al final es es 0 + 0 por que es en el grafico de las x 0 y en el grafico de las y 0)
# tamaño de la ventana emergente
aplicacion.geometry("1160x630+0+0")
# siempre se pone (False,False)
# evitar que agranden la pantalla
...
# en bg = "aca" se le puede poner nombre de colores en ingles o con el sistema RGB
# para busacr colores en google (interfas grafica tkinter/ nombre colores)
# bg significa:  backgraund
# color de fondo de la ventana
aplicacion.config(bg="burlywood")

# frame es el cuadro o el marco, Frame(dentro de aplicacion), bd = borde
# relieve relief= FLAT, RAISED, SUNKEN, GROOVE, RIDGE SON RELIEVES QUE SE PUEDEN USAR
# panel_superior.pack(side=TOP) para ubicar en la parte superior
...
# etiqueta : Label(donde va a ir, texto= "lo que dice", fg = color de letras
# fuente: font( (Arial), 58(tamaño texto)), bg= color de fondo, width= ancho de etiqueta)
# cuadricula: grid() grid es lo que perimte ubicarla segun una cuadricula
...
# panel izquierdo
panel_izquiero = Label(aplicacion, bd=1, relief=FLAT)
panel_izquiero.pack(side=LEFT)

# panel costos
panel_costos = Frame(panel_izquiero, bd=1, relief=FLAT, bg="azure4", padx=70)
...
# panel derecha
panel_derecha = Label(aplicacion, bd=1, relief=FLAT)
...
# lista de productos
listas_comidas = ["pollo", "cordero", "salmon", "merluza", "kabeb", "pizza1", "pizza2", "pizza3"]
