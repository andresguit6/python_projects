...
def codificar (imagenes):
    ...
    for imagen in imagenes:
        ...
        # codificar
        coficicado = fr.face_encodings(imagen)[0]

        # agregar a la lista
        lista_codificada.append(coficicado)
...
if not exito:
    ...
    for caracodif, caraubic in zip(cara_capturada_codificada, cara_captura):
        ...
        if distancias[indice_coincidencia] > 0.6:
            print("No coinncide con ninguno de nuestros empleados")
